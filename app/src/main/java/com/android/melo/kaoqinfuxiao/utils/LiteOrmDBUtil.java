...
public class LiteOrmDBUtil {
    ...
    public static void createLiteOrm(Context context) {
        DB_NAME = context.getFilesDir().getAbsolutePath() + "/kaoqinji.db";
        liteOrm = LiteOrm.newCascadeInstance(Global.getInstance(), DB_NAME);
